...
{
	if (ft_atoi(arg) == 1)
		win->k = make_complex(0, 0.8);
	else if (ft_atoi(arg) == 2)
		win->k = make_complex(0.37, 0.1);
	else if (ft_atoi(arg) == 3)
		win->k = make_complex(0.355, 0.355);
	else if (ft_atoi(arg) == 4)
		win->k = make_complex(-0.54, 0.54);
	else if (ft_atoi(arg) == 5)
		win->k = make_complex(-0.4, -0.59);
	else if (ft_atoi(arg) == 6)
		win->k = make_complex(0.34, -0.5);
	else if (ft_atoi(arg) == 7)
		win->k = make_complex(0.285, 0);
	else if (ft_atoi(arg) == 8)
		win->k = make_complex(-0.8, 0.156);
	else if (ft_atoi(arg) == 9)
		win->k = make_complex(0.285, 0.1);
	else if (ft_atoi(arg) == 10)
		win->k = make_complex(-0.75, 0.11);
	else if (ft_atoi(arg) == 11)
		win->k = make_complex(-1.476, 0);
	else if (ft_atoi(arg) == 12)
		win->k = make_complex(0.355534, -0.337292);
}
